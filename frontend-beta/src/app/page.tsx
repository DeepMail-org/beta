...
const Features = dynamic(() => import("@/components/features_section"), {
...
const FeaturesAndBenefits = dynamic(
	() =>
		import("@/components/features-and-benefits").then(
...
const PerspectiveMarquee = dynamic(
	() =>
		import("@/components/ui/remocn-perspective-marquee").then(
...
const FAQWithSpiral = dynamic(() => import("@/components/ui/faq-section"), {
	loading: () => <SectionSkeleton h="h-[640px]" />,
	ssr: false,
});
